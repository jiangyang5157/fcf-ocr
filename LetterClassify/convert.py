...
def convert(options):
    ...
    x_single = tf.placeholder(tf.float32, [1, train.IMAGE_WIDTH, train.IMAGE_HEIGHT, train.IMAGE_CHANNEL_NUM],
                              name="input_single")
...
def build_parser():
    ...
    parser.add_argument('--model_dir', dest='model_dir', default='/Users/Tracy/Documents/FCF/LetterClassify/saved_model_capital',
                        help='directory where checkpoints are saved')
    parser.add_argument('--output_file', dest='output_file', default='/Users/Tracy/Documents/FCF/LetterClassify/capital.tflite',
